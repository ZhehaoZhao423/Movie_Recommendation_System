...
def train(dataset, args):
    ...
    embedding_save_path = os.path.join(output_dir, "best_embeddings.pth")
    ...
    for epoch_id in range(args.num_epochs):
        ...
        with torch.no_grad():
            ...
            val_score = evaluation.evaluate_nn(dataset, h_item, args.k, args.batch_size)
            ...
            if val_score > best_val_score:
                ...
                # Save embeddings
                torch.save(h_item, embedding_save_path)
                print(f"Best embeddings saved to {embedding_save_path}")
            else:
                counter += 1
                if counter >= patience:
